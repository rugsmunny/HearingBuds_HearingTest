...
function getFormSlide() {
  ...
  $("#form-btn").addEventListener("click", (event) => {
    ...
    USER_DATA.yearOfBirth = yearOfBirth.value;
    gender.forEach((radioButton) => {
    ...
    $all(".input-checkbox").forEach((checkbox) => {
      ...
      if (checkbox.id === "other" && checkbox.checked) {
        USER_DATA.difficulties[key] = $("#other-text").value;
      }
    });
...
function validateForm() {
  ...
  const otherCheckboxChecked = $("#other").checked;
...
async function playback(volume = 5) {
  ...
  console.log(`playback volume is ${volume}`);

  return new Promise((resolve, reject) => {
    const audio = new Audio(`resources/sounds/${volume * 2}000_50.ogg`);
...
async function handleVolumeButtonClick(event) {
  event.preventDefault();
  const value =
  ...
  $all(".sound-track-button").forEach(
    (button) => (button.querySelector("path").style.fill = "#147647")
  );
  await playback(soundTrackEclipseTracker);
  $all(".sound-track-button").forEach(
...
function displayModal(text) {
  ...
  $("#dialog").showModal();
  const dialogCloseButton = $("#dialog-close-btn");
      ...
      .forEach((button) =>
        button.addEventListener("click", () => {
          if (button.classList.contains("cancel")) {
            ...
            resetUserData();
            navigate(button.getAttribute("data-direction"));
          }
        })
      );
  });
...
<section class="part-1">
    ...
    <ul class="checkbox-list inter-fs-1p5-fw-400-lh-2p25">
        <li>
            <input type="checkbox" id="noisy-environment" name="noisy-environment" class="input-checkbox difficulties">
        ...
        <li>
            <input type="checkbox" id="talking-to-people" name="talking-to-people" class="input-checkbox difficulties">
        ...
        <li>
            <input type="checkbox" id="never" name="never" class="input-checkbox difficulties">
      ...
      <div class="part-4">
        <section class="calibrate">
          ...
          <div id="play" class="calibrate-button button">
            ...
            <svg class="hidden" width="63" height="63" viewBox="5 0 63 63" fill="#fff" xmlns="http://www.w3.org/2000/svg">
<g id="play_arrow">
<path id="Vector" d="M19 47H27.6667V16H19V47ZM36.3333 16V47H45V16H36.3333Z" fill="#fff"/>
</g>
</svg>
              <svg xmlns="http://www.w3.org/2000/svg" width="73" height="73" viewBox="0 0 63 63" fill="#fff">
                <path
                ...
                <div class="volume">
                    <div class="volume indicator">
                        ...
                        <div class="track">
                            ...
                            </svg><svg xmlns="http://www.w3.org/2000/svg" width="2" height="11" viewBox="0 0 2 11" fill="none">
                            <path d="M1 1.875L1 9.375" stroke="white" stroke-width="2" stroke-linecap="round"/>
                            </svg><svg xmlns="http://www.w3.org/2000/svg" width="2" height="11" viewBox="0 0 2 11" fill="none">
                            <path d="M1 1.875L1 9.375" stroke="white" stroke-width="2" stroke-linecap="round"/>
                            </svg><svg xmlns="http://www.w3.org/2000/svg" width="2" height="11" viewBox="0 0 2 11" fill="none">
...
<dialog id="dialog">
  <p id="dialog-text"></p>
  <div class="nav-container button" id="restart-dialog">
    <section class="nav-button restart-test" data-direction="0">
      <div>
        <p>
            Restart hearing test
    ...
    <section class="nav-button cancel">
      <div>
          <p>
